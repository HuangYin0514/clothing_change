...
# -------------------------- 配置参数 --------------------------
# 请修改以下三个路径为你实际的文件夹路径
FOLDER1_PATH = "/Users/drhy/Downloads/Visible_Infrared_Person_ReID_3/results_B/outputs/rank/"  # 第一个图片文件夹
FOLDER2_PATH = "/Users/drhy/Downloads/Visible_Infrared_Person_ReID_3/results_AS/outputs/rank/"  # 第二个图片文件夹
OUTPUT_FOLDER = "./results/merged_photos"  # 输出文件夹（当前目录下）
# -------------------------------------------------------------
